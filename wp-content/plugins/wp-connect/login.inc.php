...
<div id="login"><h1><a href="<?php bloginfo('url'); ?>/" title="<?php bloginfo('name'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="<?php bloginfo( 'name' ); ?>" /></a></h1>
<div id="message" >
<?php
if($errors){
...
<form name="registerform" id="registerform" action="" method="post">
	...
	<p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary button-large" value="确定" tabindex="100" /></p>
</form>
<p id="nav">
